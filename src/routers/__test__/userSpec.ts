...
describe('User API Endpoints', () => {
  ...
  describe('Test Authenticate methods', () => {
    it('should be able to authenticate to get token', async () => {
      ...
      expect(email).toBe('test@test10.com')
      token = userToken
    })
  ...
  describe('Test CRUD API methods', () => {
    ...
    it('should get user info', async () => {
      ...
      expect(res.body.data.email).toBe('test@test10.com')
    })
    ...
    it('should update user info', async () => {
      ...
      expect(user_name).toBe('mohammedelSaber')
      expect(first_name).toBe('Mohammed')
      expect(last_name).toBe('saber')
    })
    ...
    it('should delete user', async () => {
      ...
      expect(res.body.data.user_name).toBe('mohammedelSaber')
    })
  })
})
